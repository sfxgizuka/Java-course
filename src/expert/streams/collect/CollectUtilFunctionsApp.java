package expert.streams.collect;
...
public class CollectUtilFunctionsApp {
    public static void main(String[] args) {
        List<String> playerNames = Arrays.asList("Azita", "Lamar", "Maui");
        List<Integer> playerDamage = Arrays.asList(12, 20, 15, 120, 30, 16, 40, 20, 100);
        List<Double> playerDamageDouble = Arrays.asList(12.0, 20.0, 15.0, 120.0, 30.0, 16.0, 40.0, 20.0, 100.0);
